...
export declare const user: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
    ...
    columns: {
        ...
        role: import("drizzle-orm/sqlite-core").SQLiteColumn<{
            ...
            dataType: "string";
            columnType: "SQLiteText";
            data: "admin" | "manager" | "staff" | "guest";
            driverParam: string;
            notNull: true;
            hasDefault: true;
            isPrimaryKey: false;
            isAutoincrement: false;
            hasRuntimeDefault: false;
            enumValues: ["admin", "manager", "staff", "guest"];
            baseColumn: never;
            identity: undefined;
            generated: undefined;
        }, {}, {
        ...
        defaultCategoryId: import("drizzle-orm/sqlite-core").SQLiteColumn<{
...
export declare const userRelations: import("drizzle-orm").Relations<"user", {
    ...
    subUser: import("drizzle-orm").Many<"user">;
    parentUser: import("drizzle-orm").One<"user", false>;
    categoryAsParent: import("drizzle-orm").Many<"category">;
    categoryAsCreator: import("drizzle-orm").Many<"category">;
    vendorAsParent: import("drizzle-orm").Many<"vendor">;
    vendorAsCreator: import("drizzle-orm").Many<"vendor">;
    defaultCategory: import("drizzle-orm").One<"category", false>;
    itemsAsParent: import("drizzle-orm").Many<"product">;
    itemsAsCreator: import("drizzle-orm").Many<"product">;
}>;
